    ...
    public class PageLinkTagHelperTests
    {
        ...
        public void Can_Generate_Page_Links()
        {
            ...
            urlHelper.SetupSequence(x => x.Action(It.IsAny<UrlActionContext>()))
                ...
                .Returns("Test/Page2")
                .Returns("Test/Page3");
            var urpHelperFactory = new Mock<IUrlHelperFactory>();
            urpHelperFactory.Setup(f =>
            f.GetUrlHelper(It.IsAny<ActionContext>()))
            .Returns(urlHelper.Object);
            PageLinkTagHelper helper = new PageLinkTagHelper(urpHelperFactory.Object)
            {
                PageModel = new PadingInfo
                {
                    CurrentPage = 2,
                    TotalItems = 28,
                    ItemsPerPage = 10
